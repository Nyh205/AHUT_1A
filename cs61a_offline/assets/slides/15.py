...
class TreeIterator:
    ...
    def __next__(self):
        if ____________________________:
            curr_node = self.queue.____________________________
            for b in curr_node.branches:
                self.queue.____________________________
...
def reveal_winner(t: Tree):
    """
    CS 61A SU26 MT Q6 Bracket Breaker: https://cs61a.org/exam/su26/mt1/61a-su26-mt1.pdf#page=12
    ...
    def prune_lowest_losers(t: Tree):
        ...
        for b in t.branches:
            new_b, child_changed = __(d)__
            if __(e)__:
                new_branches.__(f)__
        ...
        if t.label == __(g)__ and __(h)__:
            return __(i)__, True
